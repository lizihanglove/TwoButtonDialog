package website.lizihanglove.twobuttondialog.View;
...
import website.lizihanglove.twobuttondialog.R;
...
public class TwoButtonDialog extends Dialog {
	...
	public static class Builder {
		...
		public TwoButtonDialog create() {
			...
			final TwoButtonDialog dialog = new TwoButtonDialog(context,R.style.Dialog);
